...
- GitHub Actions bumped off the deprecated Node 20 runtime (`checkout@v5`, `setup-python@v6`, `setup-node@v5`, `upload-artifact@v5`, `download-artifact@v5`), and CI installs Node 22.
